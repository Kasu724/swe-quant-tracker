...
export default function SettingsLoading() {
  return (
    <Container className="space-y-8 py-10" role="status" aria-label="Loading settings">
      ...
      <section className="max-w-xl rounded-xl border border-slate-200 bg-white p-5 sm:p-6 dark:bg-slate-900">
      ...
      <section className="max-w-3xl rounded-xl border border-slate-200 bg-white p-5 sm:p-6 dark:bg-slate-900">
