...
export default function Loading() {
  return (
    <div role="status" aria-label="Loading page">
      <aside className="fixed bottom-0 left-0 top-16 z-20 hidden w-80 border-r border-zinc-200 bg-white p-5 xl:block dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <Container className="space-y-8 py-10 xl:max-w-none xl:pl-[22rem]">
        ...
        <div className="space-y-4">
          ...
          {[0, 1, 2].map((row) => (
            <div key={row} className="space-y-4 border-b border-zinc-200 py-5 first:pt-0">
