...
-- CreateEnum
CREATE TYPE "RoleCategory" AS ENUM ('SWE', 'QUANT_DEV', 'QUANT_RESEARCH', 'TRADING', 'DATA_ML_AI', 'DATA', 'ML_AI', 'SECURITY', 'INFRA_SYSTEMS', 'HARDWARE_FPGA_LOW_LATENCY', 'HARDWARE_EMBEDDED', 'ENGINEERING', 'PRODUCT_PM', 'OTHER');
